...
type YggdrasilManagerV16Suite struct{}

var _ = Suite(&YggdrasilManagerV16Suite{})

func (s YggdrasilManagerV16Suite) TestCalcTargetAmounts(c *C) {
	var pools []Pool
	p := NewPool()
	...
	ymgr := NewYggMgrV16(keeper.KVStoreDummy{})
...
func (s YggdrasilManagerV16Suite) TestCalcTargetAmounts2(c *C) {
...
func (s YggdrasilManagerV16Suite) TestCalcTargetAmounts3(c *C) {
...
func (s YggdrasilManagerV16Suite) TestCalcTargetAmounts4(c *C) {
...
func (s YggdrasilManagerV16Suite) TestFund(c *C) {
...
func (s YggdrasilManagerV16Suite) TestNotEnabledPoolAssetWillNotFundYggdrasil(c *C) {
	ctx, k := setupKeeperForTest(c)
	vault := GetRandomVault()
...
func (s YggdrasilManagerV16Suite) TestAbandonYggdrasil(c *C) {
	ctx, k := setupKeeperForTest(c)
	vault := GetRandomVault()
	vault.Coins = common.Coins{
		common.NewCoin(common.RuneAsset(), cosmos.NewUint(10000*common.One)),
...
func (s YggdrasilManagerV16Suite) TestAbandonYggdrasilWithDifferentConditions(c *C) {
	ctx, k := setupKeeperForTest(c)
	vault := GetRandomVault()
	vault.Coins = common.Coins{
		common.NewCoin(common.RuneAsset(), cosmos.NewUint(10000*common.One)),
