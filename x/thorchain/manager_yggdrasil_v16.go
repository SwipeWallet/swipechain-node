...
type YggMgrV16 struct {
	keeper keeper.Keeper
}

func NewYggMgrV16(keeper keeper.Keeper) *YggMgrV16 {
	return &YggMgrV16{
		keeper: keeper,
	}
}
...
func (ymgr YggMgrV16) Fund(ctx cosmos.Context, mgr Manager, constAccessor constants.ConstantValues) error {
...
// yggdrasil pool
func (ymgr YggMgrV16) sendCoinsToYggdrasil(ctx cosmos.Context, coins common.Coins, ygg Vault, mgr Manager) (int, error) {
	var count int
...
func (ymgr YggMgrV16) calcTargetYggCoins(pools []Pool, ygg Vault, yggBond, totalBond, yggFundLimit cosmos.Uint) (common.Coins, error) {
...
func (ymgr YggMgrV16) abandonYggdrasilVaults(ctx cosmos.Context, mgr Manager) error {
...
func (ymgr YggMgrV16) slash(ctx cosmos.Context, slasher Slasher, mgr Manager, pk common.PubKey, ygg Vault) error {
