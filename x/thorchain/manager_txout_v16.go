...
// TxOutStorageV16 is going to manage all the outgoing tx
type TxOutStorageV16 struct {
	keeper        keeper.Keeper
	constAccessor constants.ConstantValues
	eventMgr      EventManager
}

// NewTxOutStorageV16 will create a new instance of TxOutStore.
func NewTxOutStorageV16(keeper keeper.Keeper, constAccessor constants.ConstantValues, eventMgr EventManager) *TxOutStorageV16 {
	return &TxOutStorageV16{
		keeper:        keeper,
		eventMgr:      eventMgr,
...
func (tos *TxOutStorageV16) GetBlockOut(ctx cosmos.Context) (*TxOut, error) {
	return tos.keeper.GetTxOut(ctx, common.BlockHeight(ctx))
}

// GetOutboundItems read all the outbound item from kv store
func (tos *TxOutStorageV16) GetOutboundItems(ctx cosmos.Context) ([]*TxOutItem, error) {
...
func (tos *TxOutStorageV16) GetOutboundItemByToAddress(ctx cosmos.Context, to common.Address) []TxOutItem {
...
func (tos *TxOutStorageV16) ClearOutboundItems(ctx cosmos.Context) {
...
func (tos *TxOutStorageV16) TryAddTxOutItem(ctx cosmos.Context, mgr Manager, toi *TxOutItem) (bool, error) {
...
// fee deduction, etc
func (tos *TxOutStorageV16) UnSafeAddTxOutItem(ctx cosmos.Context, mgr Manager, toi *TxOutItem) error {
...
func (tos *TxOutStorageV16) prepareTxOutItem(ctx cosmos.Context, toi *TxOutItem) (bool, error) {
...
func (tos *TxOutStorageV16) addToBlockOut(ctx cosmos.Context, mgr Manager, toi *TxOutItem) error {
...
func (tos *TxOutStorageV16) nativeTxOut(ctx cosmos.Context, mgr Manager, toi *TxOutItem) error {
...
func (tos *TxOutStorageV16) collectYggdrasilPools(ctx cosmos.Context, tx ObservedTx, gasAsset common.Asset) (Vaults, error) {
...
func (tos *TxOutStorageV16) deductVaultPendingOutboundBalance(ctx cosmos.Context, vault Vault) (Vault, error) {
...
func (tos *TxOutStorageV16) deductVaultBlockPendingOutbound(vault Vault, block *TxOut) Vault {
