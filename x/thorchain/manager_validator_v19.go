...
// validatorMgrV19 is to manage a list of validators , and rotate them
type validatorMgrV19 struct {
	k          keeper.Keeper
...
// newValidatorMgrV19 create a new instance of validatorMgrV19
func newValidatorMgrV19(k keeper.Keeper, vaultMgr VaultManager, txOutStore TxOutStore, eventMgr EventManager) *validatorMgrV19 {
	return &validatorMgrV19{
		k:          k,
		vaultMgr:   vaultMgr,
		txOutStore: txOutStore,
		eventMgr:   eventMgr,
...
func (vm *validatorMgrV19) BeginBlock(ctx cosmos.Context, constAccessor constants.ConstantValues) error {
...
func (vm *validatorMgrV19) EndBlock(ctx cosmos.Context, mgr Manager, constAccessor constants.ConstantValues) []abci.ValidatorUpdate {
	height := common.BlockHeight(ctx)
...
func (vm *validatorMgrV19) getChangedNodes(ctx cosmos.Context, activeNodes NodeAccounts) (NodeAccounts, NodeAccounts, error) {
...
func (vm *validatorMgrV19) payNodeAccountBondAward(ctx cosmos.Context, na NodeAccount) error {
...
func (vm *validatorMgrV19) processRagnarok(ctx cosmos.Context, mgr Manager, constAccessor constants.ConstantValues) error {
...
func (vm *validatorMgrV19) getPendingTxOut(ctx cosmos.Context, constAccessor constants.ConstantValues) (int64, error) {
...
func (vm *validatorMgrV19) ragnarokProtocolStage1(ctx cosmos.Context, mgr Manager) error {
	return vm.recallYggFunds(ctx, mgr)
}

func (vm *validatorMgrV19) ragnarokProtocolStage2(ctx cosmos.Context, nth int64, mgr Manager, constAccessor constants.ConstantValues) error {
	// Ragnarok Protocol
...
func (vm *validatorMgrV19) ragnarokBondReward(ctx cosmos.Context) error {
...
func (vm *validatorMgrV19) ragnarokReserve(ctx cosmos.Context, nth int64, mgr Manager) error {
...
func (vm *validatorMgrV19) ragnarokBond(ctx cosmos.Context, nth int64, mgr Manager) error {
...
func (vm *validatorMgrV19) ragnarokPools(ctx cosmos.Context, nth int64, mgr Manager, constAccessor constants.ConstantValues) error {
...
func (vm *validatorMgrV19) RequestYggReturn(ctx cosmos.Context, node NodeAccount, mgr Manager) error {
...
func (vm *validatorMgrV19) recallYggFunds(ctx cosmos.Context, mgr Manager) error {
...
func (vm *validatorMgrV19) setupValidatorNodes(ctx cosmos.Context, height int64, constAccessor constants.ConstantValues) error {
	if height != genesisBlockHeight {
...
func (vm *validatorMgrV19) findBadActors(ctx cosmos.Context, minSlashPointsForBadValidator, badValidatorRedline, badValidatorRate int64) (NodeAccounts, error) {
...
func (vm *validatorMgrV19) findOldActor(ctx cosmos.Context) (NodeAccount, error) {
	na := NodeAccount{}
	nas, err := vm.k.ListActiveNodeAccounts(ctx)
	if err != nil {
		return na, err
...
func (vm *validatorMgrV19) markActor(ctx cosmos.Context, na NodeAccount, reason string) error {
...
func (vm *validatorMgrV19) markOldActor(ctx cosmos.Context, rate int64) error {
...
func (vm *validatorMgrV19) markBadActor(ctx cosmos.Context, minSlashPointsForBadValidator, redline, rate int64) error {
	if common.BlockHeight(ctx)%rate == 0 {
...
func (vm *validatorMgrV19) markLowerVersion(ctx cosmos.Context, rate int64) error {
	if common.BlockHeight(ctx)%rate == 0 {
...
func (vm *validatorMgrV19) findLowerVersionActor(ctx cosmos.Context) (NodeAccount, error) {
...
func (vm *validatorMgrV19) markReadyActors(ctx cosmos.Context, constAccessor constants.ConstantValues) error {
...
func (vm *validatorMgrV19) NodeAccountPreflightCheck(ctx cosmos.Context, na NodeAccount, constAccessor constants.ConstantValues) (NodeStatus, error) {
...
func (vm *validatorMgrV19) nextVaultNodeAccounts(ctx cosmos.Context, targetCount int, constAccessor constants.ConstantValues) (NodeAccounts, bool, error) {
