...
// VaultMgrV15 is going to manage the vaults
type VaultMgrV15 struct {
	k          keeper.Keeper
...
func NewVaultMgrV15(k keeper.Keeper, txOutStore TxOutStore, eventMgr EventManager) *VaultMgrV15 {
	return &VaultMgrV15{
		k:          k,
		txOutStore: txOutStore,
		eventMgr:   eventMgr,
...
func (vm *VaultMgrV15) processGenesisSetup(ctx cosmos.Context) error {
...
func (vm *VaultMgrV15) EndBlock(ctx cosmos.Context, mgr Manager, constAccessor constants.ConstantValues) error {
	if common.BlockHeight(ctx) == genesisBlockHeight {
...
func (vm *VaultMgrV15) TriggerKeygen(ctx cosmos.Context, nas NodeAccounts) error {
...
func (vm *VaultMgrV15) RotateVault(ctx cosmos.Context, vault Vault) error {
	active, err := vm.k.GetAsgardVaultsByStatus(ctx, ActiveVault)
	if err != nil {
		return err
	}
...
// and ragnaroks them
func (vm *VaultMgrV15) manageChains(ctx cosmos.Context, mgr Manager, constAccessor constants.ConstantValues) error {
...
// ragnarok'ed
func (vm *VaultMgrV15) findChainsToRetire(ctx cosmos.Context) (common.Chains, error) {
...
func (vm *VaultMgrV15) recallChainFunds(ctx cosmos.Context, chain common.Chain, mgr Manager) error {
...
func (vm *VaultMgrV15) ragnarokChain(ctx cosmos.Context, chain common.Chain, nth int64, mgr Manager, constAccessor constants.ConstantValues) error {
...
func (vm *VaultMgrV15) UpdateVaultData(ctx cosmos.Context, constAccessor constants.ConstantValues, gasManager GasManager, eventMgr EventManager) error {
...
func (vm *VaultMgrV15) getTotalStakedRune(ctx cosmos.Context) (Pools, cosmos.Uint, error) {
...
func (vm *VaultMgrV15) getTotalActiveBond(ctx cosmos.Context) (cosmos.Uint, error) {
...
// Pays out Rewards
func (vm *VaultMgrV15) payPoolRewards(ctx cosmos.Context, poolRewards []cosmos.Uint, pools Pools) error {
...
func (vm *VaultMgrV15) calcPoolDeficit(stakerDeficit, totalFees, poolFees cosmos.Uint) cosmos.Uint {
...
func (vm *VaultMgrV15) calcBlockRewards(totalStaked, totalBonded, totalReserve, totalLiquidityFees cosmos.Uint, emissionCurve, blocksPerYear int64) (cosmos.Uint, cosmos.Uint, cosmos.Uint) {
...
func (vm *VaultMgrV15) getPoolShare(totalStaked, totalBonded, totalRewards cosmos.Uint) cosmos.Uint {
